...
- Agent Installer: https://github.com/TrakHound/MTConnect.NET/releases/tag/v6.0.9-beta
...
![Traditional Agent Architecture](https://raw.githubusercontent.com/TrakHound/MTConnect.NET/master/img/mtconnect-agent-shdr-mqtt-communication-white.png)
