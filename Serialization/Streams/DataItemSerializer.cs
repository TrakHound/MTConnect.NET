...
namespace MTConnect.Serialization.Streams
{
    /// <summary>
    /// Utility service for serialization.
    /// </summary>
    public sealed class DataItemSerializer
    {
        /// <summary>
        /// Serialize an object
        /// </summary>
        ...
        //{
        //    var s = new XmlSerializer(obj.GetType(), SerializableExtraTypes.GetTypes(root));
        //    var stream = new MemoryStream();
        //    var xw = new XmlTextWriter(stream, null);
        ...
        {
            var serializer = new XmlSerializer(typeof(MTConnectStreams.DataItem));
