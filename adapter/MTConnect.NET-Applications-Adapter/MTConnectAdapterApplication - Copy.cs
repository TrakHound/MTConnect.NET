...
namespace MTConnect.Applications
{
    ...
    /// </summary>
    public class MTConnectAdapterApplication<TConfiguration> : IMTConnectAdapterApplication where TConfiguration : AdapterApplicationConfiguration
    {
        ...
        private MTConnectAdapterEngine<TConfiguration> _engine;
        private IMTConnectAdapter _adapter;
        ...
        public MTConnectAdapterEngine<TConfiguration> Engine => _engine;

        public IMTConnectAdapter Adapter => _adapter;

        public EventHandler<AdapterApplicationConfiguration> OnRestart { get; set; }


        public MTConnectAdapterApplication(MTConnectAdapterEngine<TConfiguration> engine)
        {
            _engine = engine;
            ...
            if (ConfigurationType == null) ConfigurationType = typeof(AdapterApplicationConfiguration);
        }
        ...
        protected virtual IAdapterApplicationConfiguration OnConfigurationFileRead(string configurationPath)
        {
            // Read the Configuration File
            return AdapterApplicationConfiguration.Read<AdapterApplicationConfiguration>(configurationPath);
        }
