...
namespace MTConnect.Applications
{
    public class Program
    {
        ...
        private const string ApplicationName = "MTConnect HTTP Gateway Agent";
        ...
        public static void Main(string[] args)
        {
            ...
            // an HTTP server, HTTP MTConnect clients, Command line arguments, Device management, Buffer management, Logging, Windows Service, and Configuration File management
            var agentApplication = new MTConnectHttpAgentGatewayApplication();
