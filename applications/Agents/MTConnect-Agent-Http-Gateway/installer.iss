; MTConnect HTTP Gateway Agent Installer
; ------------------------------

#define MyAppName "MTConnect HTTP Gateway Agent"
...
; File Names
#define ExeName "MTConnect-HTTP-Gateway-Agent.exe"
...
AppId={{DE86FD16-7F02-4590-8BF0-03198CD0EB26}
...
DefaultDirName={autopf}\{#MyAppPublisher}\MTConnect-HTTP-Gateway-Agent
UsePreviousAppDir=false
OutputBaseFilename=MTConnect-Http-Gateway-Agent-Install-v{#MyAppVersion}
