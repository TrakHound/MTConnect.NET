...
AppId={{CB240583-B854-42D3-BBAC-2C80F179D48D}
...
DefaultDirName={autopf}\{#MyAppPublisher}\MTConnect-HTTP-Agent
UsePreviousAppDir=false
OutputBaseFilename=MTConnect-Http-Agent-Install-v{#MyAppVersion}
