; MTConnect MQTT Broker Gateway Agent Installer
; ------------------------------

#define MyAppName "MTConnect MQTT Broker Gateway Agent"
...
; File Names
#define ExeName "MTConnect-MQTT-Broker-Gateway-Agent.exe"
...
DefaultDirName={autopf}\{#MyAppPublisher}\MTConnect-MQTT-Broker-Gateway-Agent
UsePreviousAppDir=false
OutputBaseFilename=MTConnect-MQTT-Broker-Gateway-Agent-Install-v{#MyAppVersion}
