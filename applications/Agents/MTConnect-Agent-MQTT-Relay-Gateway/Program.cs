...
namespace MTConnect.Applications
{
    public class Program
    {
        ...
        private const string ApplicationName = "MTConnect MQTT Relay Gateway Agent";
        ...
        public static void Main(string[] args)
        {
            ...
            // an MQTT broker connection, HTTP MTConnect clients, Command line arguments, Device management, Buffer management, Logging, Windows Service, and Configuration File management
            var agentApplication = new MTConnectMqttRelayAgentGatewayApplication();
