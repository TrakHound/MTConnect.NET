; MTConnect MQTT Relay Gateway Agent Installer
; ------------------------------

#define MyAppName "MTConnect MQTT Relay Gateway Agent"
...
; File Names
#define ExeName "MTConnect-MQTT-Relay-Gateway-Agent.exe"
...
AppId={{F5F94031-BFAD-4E9C-9A36-A36D8CD5AB36}
...
DefaultDirName={autopf}\{#MyAppPublisher}\MTConnect-MQTT-Relay-Gateway-Agent
UsePreviousAppDir=false
OutputBaseFilename=MTConnect-MQTT-Relay-Gateway-Agent-Install-v{#MyAppVersion}
