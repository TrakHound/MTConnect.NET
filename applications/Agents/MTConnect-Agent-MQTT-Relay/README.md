...
## Overview
This project is a full implementation of an MTConnect Agent used to read data from industrial machine tools and devices. This MTConnect Agent application is fully compatible with the latest **Version 2.1 of the MTConnect Standard**. It uses the SHDR protocol to receive data from Adapters and an MQTT client to publish messages to an external MQTT Broker.

#### Features
- MQTT client to publish to an external broker
...
- [Download Latest Release Windows Installer](https://github.com/TrakHound/MTConnect.NET/releases/download/v5.1.0/TrakHound-MTConnect-MQTT-Relay-Agent-Install-v5.1.0.exe)
