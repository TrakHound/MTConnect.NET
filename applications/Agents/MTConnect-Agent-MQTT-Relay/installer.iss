; MTConnect MQTT Relay Agent Installer
; ------------------------------

#define MyAppName "MTConnect MQTT Relay Agent"
...
; File Names
#define ExeName "MTConnect-MQTT-Relay-Agent.exe"
...
DefaultDirName={autopf}\{#MyAppPublisher}\MTConnect-MQTT-Relay-Agent
UsePreviousAppDir=false
OutputBaseFilename=MTConnect-MQTT-Relay-Agent-Install-v{#MyAppVersion}
