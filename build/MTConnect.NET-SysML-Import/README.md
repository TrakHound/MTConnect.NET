...
| `JsonCppAgentTemplateRenderer` | `libraries/MTConnect.NET-JSON-cppagent/` | `JsonComponents.g.cs`, `JsonEvents.g.cs`, `JsonSamples.g.cs` — flat catalogue files that the cppagent JSON formatter reflects over. |
