...
Publishes outbound MQTT messages to an external broker. The agent acts as a client. Module key: `mqtt-relay`. Implementation: `MTConnect.NET-AgentModule-MqttRelay`. The configuration object is `MqttRelayModuleConfiguration`.
...
|---|---|
| `http-server` | `MTConnect.Configurations.HttpServerModuleConfiguration` |
| `mqtt-broker` | `MTConnect.Configurations.MqttBrokerModuleConfiguration` |
| `mqtt-relay` | `MTConnect.Configurations.MqttRelayModuleConfiguration` |
| `mqtt-adapter` | `MTConnect.Configurations.MqttAdapterModuleConfiguration` |
| `shdr-adapter` | `MTConnect.Configurations.ShdrAdapterModuleConfiguration` |
| `http-adapter` | `MTConnect.Configurations.HttpAdapterModuleConfiguration` |
