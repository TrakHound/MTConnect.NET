...
Cross-implementation parity tests against `mtconnect/agent` for the v2.X JSON / XML wire shape are Docker-gated and currently surface in `tests/Compliance/.../L4_CrossImpl/` as scaffolding only.
