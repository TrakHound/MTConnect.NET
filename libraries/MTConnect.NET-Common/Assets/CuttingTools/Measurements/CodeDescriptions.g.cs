...
namespace MTConnect.Assets.CuttingTools.Measurements
{
    public static class CodeDescriptions
    {
        ...
        /// </summary>
        public const string D_CX = "Diameter of a circle on which the defined point Pk located on this cutting tool.The normal of the machined peripheral surface points towards the axis of the cutting tool.";
        ...
        /// </summary>
        public const string L_FX = "Distance from the gauge plane or from the end of the shank of the cutting tool, if a gauge plane does not exist, to the cutting reference point determined by the main function of the tool. This measurement will be with reference to the cutting tool and **MUST NOT** exist without a cutting tool.";
        ...
        /// </summary>
        public const string S_D_LX = "Length of a portion of a stepped tool that is related to a corresponding cutting diameter measured from the cutting reference point of that cutting diameter to the point on the next cutting edge at which the diameter starts to change.";
        ...
        /// </summary>
        public const string S_T_AX = "Angle between a major edge on a step of a stepped tool and the same cutting edge rotated 180 degrees about its tool axis.";
        
        /// <summary>
        /// Insert width when an inscribed circle diameter is not practical.
        /// </summary>
        public const string WONE = "Insert width when an inscribed circle diameter is not practical.";
        ...
        public static string Get(Code value)
        {
            switch (value)
            {
                case Code.APMX: return "Maximum engagement of the cutting edge or edges with the workpiece measured perpendicular to the feed motion.";
                case Code.BCH: return "Flat length of a chamfer.";
                case Code.BDX: return "Largest diameter of the body of a tool item.";
                case Code.BS: return "Measure of the length of a wiper edge of a cutting item.";
                case Code.CHW: return "Width of the chamfer.";
                case Code.CRP: return "Theoretical sharp point of the cutting tool from which the major functional dimensions are taken.";
                case Code.DC: return "Maximum diameter of a circle on which the defined point Pk of each of the master inserts is located on a tool item. The normal of the machined peripheral surface points towards the axis of the cutting tool.";
                case Code.D_CX: return "Diameter of a circle on which the defined point Pk located on this cutting tool.The normal of the machined peripheral surface points towards the axis of the cutting tool.";
                case Code.DF: return "Dimension between two parallel tangents on the outside edge of a flange.";
                case Code.DMM: return "Dimension of the diameter of a cylindrical portion of a tool item or an adaptive item that can participate in a connection.";
                case Code.DRVA: return "Angle between the driving mechanism locator on a tool item and the main cutting edge.";
                case Code.H: return "Dimension of the height of the shank.";
                case Code.HF: return "Distance from the basal plane of the tool item to the cutting point.";
                case Code.IC: return "Diameter of a circle to which all edges of a equilateral and round regular insert are tangential.";
                case Code.KAPR: return "Angle between the tool cutting edge plane and the tool feed plane measured in a plane parallel the xy-plane.";
                case Code.L: return "Theoretical length of the cutting edge of a cutting item over sharp corners.";
                case Code.LBX: return "Distance measured along the X axis from that point of the item closest to the workpiece, including the cutting item for a tool item but excluding a protruding locking mechanism for an adaptive item, to either the front of the flange on a flanged body or the beginning of the connection interface feature on the machine side for cylindrical or prismatic shanks.";
                case Code.LF: return "Distance from the gauge plane or from the end of the shank to the furthest point on the tool, if a gauge plane does not exist, to the cutting reference point determined by the main function of the tool. The CuttingTool functional length will be the length of the entire tool, not a single cutting item. Each CuttingItem can have an independent FunctionalLength represented in its measurements.";
                case Code.L_FX: return "Distance from the gauge plane or from the end of the shank of the cutting tool, if a gauge plane does not exist, to the cutting reference point determined by the main function of the tool. This measurement will be with reference to the cutting tool and **MUST NOT** exist without a cutting tool.";
                case Code.LPR: return "Dimension from the yz-plane to the furthest point of the tool item or adaptive item measured in the -X direction.";
                case Code.LS: return "Dimension of the length of the shank.";
                case Code.LUX: return "Maximum length of a cutting tool that can be used in a particular cutting operation including the non-cutting portions of the tool.";
                case Code.N_A: return "Angle of the tool with respect to the workpiece for a given process. The value is application specific.";
                case Code.OAL: return "Largest length dimension of the cutting tool including the master insert where applicable.";
                case Code.PSIR: return "Angle between the tool cutting edge plane and a plane perpendicular to the tool feed plane measured in a plane parallel the xy-plane.";
                case Code.RE: return "Nominal radius of a rounded corner measured in the X Y-plane.";
                case Code.S_D_LX: return "Length of a portion of a stepped tool that is related to a corresponding cutting diameter measured from the cutting reference point of that cutting diameter to the point on the next cutting edge at which the diameter starts to change.";
                case Code.SIG: return "Angle between the major cutting edge and the same cutting edge rotated by 180 degrees about the tool axis.";
                case Code.S_T_AX: return "Angle between a major edge on a step of a stepped tool and the same cutting edge rotated 180 degrees about its tool axis.";
                case Code.WONE: return "Insert width when an inscribed circle diameter is not practical.";
                case Code.WF: return "Distance between the cutting reference point and the rear backing surface of a turning tool or the axis of a boring bar.";
                case Code.WT: return "Total weight of the cutting tool in grams. The force exerted by the mass of the cutting tool.";
            }
