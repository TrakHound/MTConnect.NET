...
{
    /// <summary>
    /// Description text for each property of <c>Component</c> as defined by the MTConnect Standard.
    /// </summary>
    public static class ComponentDescriptions
    {
        ...
        /// </summary>
        public const string Name = "Name of the Component.name **MUST** be unique for all child Component entities of a parent Component.";
