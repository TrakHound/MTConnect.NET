...
{
    /// <summary>
    /// Description text for each property of <c>ConfigurationRelationship</c> as defined by the MTConnect Standard.
    /// </summary>
    public static class ConfigurationRelationshipDescriptions
    {
        /// <summary>
