...
// MTConnect SysML v2.3 : UML ID = _2024x_68e0225_1760880056046_720411_4043
...
namespace MTConnect.Devices.DataItems
{
    ...
    /// </summary>
    public class BindingStateDataItem : DataItem
    {
        public const DataItemCategory CategoryId = DataItemCategory.EVENT;
        public const string TypeId = "BINDING_STATE";
        public const string NameId = "bindingState";
        public const DataItemRepresentation DefaultRepresentation = DataItemRepresentation.VALUE;     
             
        public new const string DescriptionText = "State of the binding process when Component participates in a task as a collaborator";
        ...
        public BindingStateDataItem(string deviceId)
        {
        ...
        protected override ValidationResult OnValidation(Version mtconnectVersion, IObservationInput observation)
        {
            if (observation != null && !observation.Values.IsNullOrEmpty())
            {
                ...
                if (result != null)
                {
                    ...
                    var validValues = Enum.GetValues(typeof(BindingState));
                    ...
                    return new ValidationResult(false, "'" + result + "' is not a valid value for BINDING_STATE");
                }
                else
                {
