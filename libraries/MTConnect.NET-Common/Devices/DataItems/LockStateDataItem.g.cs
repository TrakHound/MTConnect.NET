...
// MTConnect SysML v2.3 : UML ID = _19_0_3_68e0225_1622457702589_196111_730
        ...
        protected override ValidationResult OnValidation(Version mtconnectVersion, IObservationInput observation)
        {
            if (observation != null && !observation.Values.IsNullOrEmpty())
            {
                ...
                if (result != null)
                {
                    ...
                    var validValues = Enum.GetValues(typeof(LockState));
                    ...
                    return new ValidationResult(false, "'" + result + "' is not a valid value for LOCK_STATE");
                }
                else
                {
