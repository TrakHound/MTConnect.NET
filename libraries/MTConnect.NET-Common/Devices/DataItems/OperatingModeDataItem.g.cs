...
// MTConnect SysML v2.3 : UML ID = _19_0_3_68e0225_1637936881318_547715_125
        ...
        protected override ValidationResult OnValidation(Version mtconnectVersion, IObservationInput observation)
        {
            if (observation != null && !observation.Values.IsNullOrEmpty())
            {
                ...
                if (result != null)
                {
                    ...
                    var validValues = Enum.GetValues(typeof(OperatingMode));
                    ...
                    return new ValidationResult(false, "'" + result + "' is not a valid value for OPERATING_MODE");
                }
                else
                {
