...
// MTConnect SysML v2.3 : UML ID = _19_0_3_68e0225_1640701999569_209325_30
        ...
        protected override ValidationResult OnValidation(Version mtconnectVersion, IObservationInput observation)
        {
            if (observation != null && !observation.Values.IsNullOrEmpty())
            {
                ...
                if (result != null)
                {
                    ...
                    var validValues = Enum.GetValues(typeof(PartCountType));
                    ...
                    return new ValidationResult(false, "'" + result + "' is not a valid value for PART_COUNT_TYPE");
                }
                else
                {
