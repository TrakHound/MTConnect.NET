...
// MTConnect SysML v2.3 : UML ID = _19_0_3_45f01b9_1580378218483_193774_2298
        ...
        protected override ValidationResult OnValidation(Version mtconnectVersion, IObservationInput observation)
        {
            if (observation != null && !observation.Values.IsNullOrEmpty())
            {
                ...
                if (result != null)
                {
                    ...
                    var validValues = Enum.GetValues(typeof(WaitState));
                    ...
                    return new ValidationResult(false, "'" + result + "' is not a valid value for WAIT_STATE");
                }
                else
                {
