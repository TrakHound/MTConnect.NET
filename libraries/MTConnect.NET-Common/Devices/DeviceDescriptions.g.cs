...
{
    /// <summary>
    /// Description text for each property of <c>Device</c> as defined by the MTConnect Standard.
    /// </summary>
    public static class DeviceDescriptions
    {
        ...
        /// </summary>
        public const string MTConnectVersion = "MTConnect version of the Device Information Model used to configure the information to be published for a piece of equipment in an MTConnect Response Document.";
        ...
        /// </summary>
        public const string Uuid = "Universally unique identifier for the element.";
