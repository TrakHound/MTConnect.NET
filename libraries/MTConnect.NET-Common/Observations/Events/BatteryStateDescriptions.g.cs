...
{
    /// <summary>
    /// Description text for each <see cref="BatteryState"/> value as defined by the MTConnect Standard.
    /// </summary>
    public static class BatteryStateDescriptions
    {
        ...
        /// <summary>
        /// Returns the MTConnect Standard description text for the specified <see cref="BatteryState"/> value, or <c>null</c> when none is defined.
        /// </summary>
