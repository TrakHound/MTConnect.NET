...
{
    /// <summary>
    /// Description text for each <see cref="CompositionStateMotion"/> value as defined by the MTConnect Standard.
    /// </summary>
    public static class CompositionStateMotionDescriptions
    {
        ...
        /// <summary>
        /// Returns the MTConnect Standard description text for the specified <see cref="CompositionStateMotion"/> value, or <c>null</c> when none is defined.
        /// </summary>
