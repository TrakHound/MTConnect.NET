...
namespace MTConnect.Devices.Xml
{
    public class XmlDevicesHeader
    {
        ...
        public static IMTConnectDevicesHeader ReadXml(XmlReader reader)
        {
            var header = new MTConnectDevicesHeader();
            ...
            header.AssetBufferSize = reader.GetAttribute("assetBufferSize").ToULong();
            header.AssetCount = reader.GetAttribute("assetCount").ToULong();
