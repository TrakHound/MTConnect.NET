...
{
    public class MTConnectHttpAdapterModule : IMTConnectAgentModule
    {
        ...
        public MTConnectHttpAdapterModule(IMTConnectAgentBroker mtconnectAgent, object configuration)
        {
