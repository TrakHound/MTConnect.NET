...
namespace MTConnect.Modules.Http
{
    ...
    public class MTConnectHttpAgentServer : MTConnectHttpServer
    {
        ...
        private readonly HttpModuleConfiguration _moduleConfiguration;


        public MTConnectHttpAgentServer(HttpModuleConfiguration configuration, IMTConnectAgentBroker mtconnectAgent) : base(configuration, mtconnectAgent)
        {
