...
{
    public class MTConnectHttpServerModule : IMTConnectAgentModule
    {
        ...
        private readonly HttpModuleConfiguration _configuration;
        ...
        public MTConnectHttpServerModule(IMTConnectAgentBroker mtconnectAgent, object controllerConfiguration)
        {
            _mtconnectAgent = mtconnectAgent;
            _configuration = AgentApplicationConfiguration.GetConfiguration<HttpModuleConfiguration>(controllerConfiguration);
        }
