...
namespace MTConnect.Applications
{
    ...
    public class Service : MTConnectAdapterService
    {
        ...
        private readonly IMTConnectShdrAdapterApplication _application;


        public Service(IMTConnectShdrAdapterApplication application, string label = null, string name = null, string displayName = null, string description = null, bool autoStart = true)
