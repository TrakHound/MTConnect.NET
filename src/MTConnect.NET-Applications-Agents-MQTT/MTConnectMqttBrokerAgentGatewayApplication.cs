...
namespace MTConnect.Applications.Agents
{
    ...
    /// </summary>
    public class MTConnectMqttBrokerAgentGatewayApplication : MTConnectMqttBrokerAgentApplication
    {
        private const string DefaultServiceName = "MTConnect-Agent-MQTT-Broker-Gateway";
        private const string DefaultServiceDisplayName = "MTConnect MQTT Broker Gateway Agent";
        ...
        public MTConnectMqttBrokerAgentGatewayApplication()
        {
