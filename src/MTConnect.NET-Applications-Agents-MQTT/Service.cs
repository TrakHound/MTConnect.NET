...
namespace MTConnect.Applications
{
    ...
    public class Service : MTConnectAgentService
    {
        ...
        private readonly IMTConnectMqttAgentApplication _application;


        public Service(IMTConnectMqttAgentApplication application, string name = null, string displayName = null, string description = null, bool autoStart = true)
