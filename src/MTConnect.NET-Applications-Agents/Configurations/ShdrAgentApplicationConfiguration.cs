...
namespace MTConnect.Configurations
{
    ...
    /// </summary>
    public class ShdrAgentApplicationConfiguration : AgentApplicationConfiguration, IShdrAgentApplicationConfiguration
    {
        /// <summary>
        ...
        public ShdrAgentApplicationConfiguration() : base()
        {
            Devices = null;
            ServiceName = null;
