...
{
    public class MTConnectHttpAgentApplication : IMTConnectAgentApplication
    {
        ...
        private AgentConfigurationFileWatcher<HttpAgentApplicationConfiguration> _agentConfigurationWatcher;
        ...
        public void StartAgent(HttpAgentApplicationConfiguration configuration, bool verboseLogging = false, int port = 0)
        {
        ...
        private void AgentConfigurationFileUpdated(object sender, HttpAgentApplicationConfiguration configuration)
        {
            if (configuration != null)
            {
