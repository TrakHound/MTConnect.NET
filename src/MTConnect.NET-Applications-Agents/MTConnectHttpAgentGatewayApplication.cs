...
namespace MTConnect.Applications.Agents
{
    ...
    public class MTConnectHttpAgentGatewayApplication : MTConnectHttpAgentApplication
    {
        ...
        public MTConnectHttpAgentGatewayApplication()
        {
            ...
            if (ConfigurationType == null) ConfigurationType = typeof(HttpAgentGatewayApplicationConfiguration);
        }
        ...
        {
            _configuration = configuration as HttpAgentGatewayApplicationConfiguration;
        }
