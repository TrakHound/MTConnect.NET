...
{
    /// <summary>
    /// An MTConnect Agent Application that supports SHDR Adapters and a built in HTTP server to support the MTConnect Rest Api Protocol.
    ...
    /// </summary>
    public class MTConnectShdrHttpAgentApplication : MTConnectHttpAgentApplication
    {
        ...
        public MTConnectShdrHttpAgentApplication()
        {
            if (ConfigurationType == null) ConfigurationType = typeof(ShdrHttpAgentApplicationConfiguration);
        }
