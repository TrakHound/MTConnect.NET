...
namespace MTConnect.Agents.Controllers
{
    ...
    public class GlobalController : ControllerBase
    {
            ...
            )
        {
            ...
            var response = await MTConnectHttpRequests.GetProbeRequest(_agent, version, documentFormat, indent);
            ...
            )
        {
            ...
            var response = await MTConnectHttpRequests.GetCurrentRequest(_agent, path, at, interval, version, documentFormat, indent);
            ...
            )
        {
            ...
            if (interval > 0)
            {
                try
                {
                    ...
                    var stream = new MTConnectHttpStream(_agent, null, path, from, count, interval, heartbeat, documentFormat, indent);
            ...
            else
            {
                ...
                var response = await MTConnectHttpRequests.GetSampleRequest(_agent, null, from, to, count, version, documentFormat, indent);
