...
namespace MTConnect.Agents
{
    ...
    public class DeviceStreamResults : IDeviceStreamResults
    {
        ...
        /// </summary>
        public IEnumerable<IDeviceStream> DeviceStreams { get; }


        public DeviceStreamResults(long firstSequence, long lastSequence, long nextSequence, IEnumerable<IDeviceStream> deviceStreams)
        {
