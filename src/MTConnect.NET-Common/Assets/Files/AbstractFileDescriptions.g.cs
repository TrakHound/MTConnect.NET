...
namespace MTConnect.Assets.Files
{
    public static class AbstractFileDescriptions
    {
        ...
        /// </summary>
        public const string ApplicationCategory = "Category of application that will use this file.";
        
        /// <summary>
        /// Type of application that will use this file.
        /// </summary>
        public const string ApplicationType = "Type of application that will use this file.";
        ...
        /// </summary>
        public const string MediaType = "Mime type of the file.";
        
        /// <summary>
        /// Name of the file.
        /// </summary>
        public const string Name = "Name of the file.";
    }
}