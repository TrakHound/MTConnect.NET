...
namespace MTConnect.Devices.DataItems
{
    public static class DataItemFilterTypeDescriptions
    {
        ...
        /// </summary>
        public const string MINIMUM_DELTA = "For a MINIMUM_DELTA type Filter, a new value MUST NOT be reported for a data item unless the measured value has changed from the last reported value by at least the delta given as the Value of this element.";
        ...
        /// </summary>
        public const string PERIOD = "For a PERIOD type Filter, the data reported for a data item is provided on a periodic basis. The PERIOD for reporting data is defined in the Value for the Filter.";
