...
namespace MTConnect.Devices.DataItems.Events
{
    ...
    public class ProcessStateDataItem : DataItem
    {
        ...
        public new const string DescriptionText = "The particular condition of the process occurrence at a specific time.";
        ...
        public ProcessStateDataItem(string parentId)
        {
        ...
        protected override ValidationResult OnValidation(Version mtconnectVersion, IObservationInput observation)
        {
            if (observation != null && !observation.Values.IsNullOrEmpty())
            {
                ...
                if (cdata != null)
                {
                    ...
                    var validValues = Enum.GetValues(typeof(Observations.Events.Values.ProcessState));
