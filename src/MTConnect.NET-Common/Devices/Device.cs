...
namespace MTConnect.Devices
{
    ...
    public class Device : IDevice
    {
        ...
        /// </summary>
        /// <param name="filePath">The path to the Device Configuration file</param>
        public static async Task<IEnumerable<IDevice>> FromFileAsync(string filePath, string documentFormatterId)
        {
            if (!string.IsNullOrEmpty(filePath))
            {
                try
        ...
        public static IEnumerable<IDevice> FromFiles(string dirPath, string documentFormatterId)
        {
        ...
        /// </summary>
        /// <param name="dirPath">The path to the directory containing Device Configuration files</param>
        public static async Task<IEnumerable<IDevice>> FromFilesAsync(string dirPath, string documentFormatterId)
        {
            if (!string.IsNullOrEmpty(dirPath))
            {
                try
