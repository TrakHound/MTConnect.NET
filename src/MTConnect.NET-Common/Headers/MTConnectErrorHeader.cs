...
{
    /// <summary>
    /// The Header element for an MTConnectErrors Response Document defines information regarding the creation
    /// of the document and the data storage capability of the Agent that generated the document.
    /// </summary>
    public class MTConnectErrorHeader : IMTConnectErrorHeader
    {
        /// <summary>
