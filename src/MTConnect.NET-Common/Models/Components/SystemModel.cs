...
namespace MTConnect.Models.Components
{
    ...
    public abstract class SystemModel : ComponentModel, ISystemModel
    {
        ...
        public IDataItemModel SystemConditionDataItem => DataItemManager.GetDataItem(Devices.Conditions.SystemCondition.NameId);
        ...
        {
            get => DataItemManager.GetCondition(Devices.Conditions.HardwareCondition.NameId);
            set => DataItemManager.AddCondition(new HardwareCondition(Id), value);
        }
        public IDataItemModel HardwareConditionDataItem => DataItemManager.GetDataItem(Devices.Conditions.HardwareCondition.NameId);
        ...
        public IDataItemModel CommunicationsConditionDataItem => DataItemManager.GetDataItem(Devices.Conditions.CommunicationsCondition.NameId);
