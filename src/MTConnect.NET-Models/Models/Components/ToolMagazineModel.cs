...
namespace MTConnect.Models.Components
{
    ...
    public class ToolMagazineModel : ToolingDeliveryModel, IToolMagazineModel
    {
        ...
        {
            get => ComponentManager.GetCompositionModel<StagingPotModel>(typeof(StagingPotComposition));
            set => ComponentManager.AddCompositionModel((StagingPotModel)value);
        }
        ...
        /// </summary>
        public IPotModel GetPot(int potNumber) => ComponentManager.GetCompositionModel<PotModel>(typeof(PotComposition), PotModel.CreateName(potNumber));
    }
}
