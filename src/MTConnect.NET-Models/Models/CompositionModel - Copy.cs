...
namespace MTConnect.Models
{
    ...
    public class CompositionModel : Composition, ICompositionModel
    {
        ...
        //internal readonly Dictionary<string, ConditionObservation> _conditions = new Dictionary<string, ConditionObservation>();
        ...
        public static ICompositionModel Create(IComposition composition)
        {
            if (composition != null)
            {
                ...
                if (obj != null)
                {
                    ...
                    if (composition.Description != null)
                    {
                        ...
                        obj.DescriptionText = composition.Description.CDATA;
                    }
        ...
        private static List<IDataItemModel> CreateDataItemModels(IEnumerable<IDataItem> dataItems)
        {
        ...
        {
            var dataItemId = DataItem.CreateId(Id, name);
        ...
        protected string GetDataItemValue(string name, string suffix)
        {
        ...
        protected ConditionObservation GetCondition(string name)
        {
        ...
        protected void UpdateCondition(string dataItemId, ConditionObservation condition)
        {
        ...
        public IEnumerable<IObservation> GetObservations()
        {
            ...
            if (!DataItems.IsNullOrEmpty())
            {
                ...
                {
                    object value = null;
                    lock (_lock) value = _dataItems.GetValueOrDefault(dataItem.Id);
                    if (value != null)
                    {
