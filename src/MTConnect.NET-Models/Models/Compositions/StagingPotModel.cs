...
namespace MTConnect.Models.Compositions
{
    ...
    /// </summary>
    public class StagingPotModel : CompositionModel, IStagingPotModel
    {
        ...
        public StagingPotModel() 
        {
            Type = StagingPotComposition.TypeId;
        }

        public StagingPotModel(string compositionId)
        {
            Id = compositionId;
            Type = StagingPotComposition.TypeId;
        }
