...
{
    public class MTConnectMqttAdapterModule : IMTConnectAgentModule
    {
        ...
        private readonly MqttAdapterConfiguration _configuration;
        ...
        public MTConnectMqttAdapterModule(IMTConnectAgentBroker mtconnectAgent, object configuration)
        {
            ...
            _configuration = AgentApplicationConfiguration.GetConfiguration<MqttAdapterConfiguration>(configuration);
