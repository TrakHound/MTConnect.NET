...
{
    public class PalletMachinePositionModel : ComponentModel
    {
        public const string TypeId = "PalletMachinePosition";
        ...
        public PalletMachinePositionModel()
        {
            Type = TypeId;
        }

        public PalletMachinePositionModel(string deviceId)
        {
            Id = deviceId;
            Type = TypeId;
            Name = deviceId;
