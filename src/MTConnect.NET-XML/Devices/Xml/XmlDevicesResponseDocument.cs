...
namespace MTConnect.Devices.Xml
{
    ...
    public class XmlDevicesResponseDocument
    {
        ...
        public static string ToXml(IDevicesResponseDocument document, IEnumerable<NamespaceConfiguration> extendedSchemas, bool indent = false, bool outputComments = false)
        {
