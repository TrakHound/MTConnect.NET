...
namespace MTConnect.Agents
{
    ...
    public interface IMTConnectAgent
    {
        ...
        DevicesDocument GetDevices(Version mtconnectVersion = null);

        /// <summary>
        /// Get a MTConnectDevices Document containing all devices.
        /// </summary>
        /// <returns>MTConnectDevices Response Document</returns>
        Task<DevicesDocument> GetDevicesAsync(Version mtconnectVersion = null);
        ...
        /// <returns>MTConnectDevices Response Document</returns>
        DevicesDocument GetDevices(string deviceName, Version mtconnectVersion = null);
        ...
        /// <param name="deviceName">The (name or uuid) of the requested Device</param>
        /// <returns>MTConnectDevices Response Document</returns>
        Task<DevicesDocument> GetDevicesAsync(string deviceName, Version mtconnectVersion = null);
        ...
        StreamsDocument GetDeviceStreams(int count = 0);
        ...
        /// <param name="count">The Maximum Number of DataItems to return</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamsAsync(int count = 0);
        ...
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStreams(long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamsAsync(long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStreams(IEnumerable<string> dataItemIds, long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamsAsync(IEnumerable<string> dataItemIds, long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStreams(long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamsAsync(long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStreams(IEnumerable<string> dataItemIds, long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamsAsync(IEnumerable<string> dataItemIds, long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStream(string deviceName, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamAsync(string deviceName, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStream(string deviceName, IEnumerable<string> dataItemIds, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamAsync(string deviceName, IEnumerable<string> dataItemIds, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStream(string deviceName, long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamAsync(string deviceName, long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStream(string deviceName, IEnumerable<string> dataItemIds, long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamAsync(string deviceName, IEnumerable<string> dataItemIds, long at, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStream(string deviceName, long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamAsync(string deviceName, long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        StreamsDocument GetDeviceStream(string deviceName, IEnumerable<string> dataItemIds, long from, long to, int count = 0);
        ...
        /// <param name="count">The maximum number of observations to include in the response</param>
        /// <returns>MTConnectStreams Response Document</returns>
        Task<StreamsDocument> GetDeviceStreamAsync(string deviceName, IEnumerable<string> dataItemIds, long from, long to, int count = 0);
        ...
        AssetsDocument GetAssets(string type = null, bool removed = false, int count = 100, Version mtconnectVersion = null);
        ...
        /// <param name="count">Defines the maximum number of Asset Documents to return in an MTConnectAssets Response Document.</param>
        /// <returns>MTConnectAssets Response Document</returns>
        Task<AssetsDocument> GetAssetsAsync(string type = null, bool removed = false, int count = 100, Version mtconnectVersion = null);
        ...
        /// <returns>MTConnectAssets Response Document</returns>
        AssetsDocument GetAsset(string assetId, Version mtconnectVersion = null);
        ...
        /// <param name="assetId">The ID of the Asset to include in the response</param>
        /// <returns>MTConnectAssets Response Document</returns>
        Task<AssetsDocument> GetAssetAsync(string assetId, Version mtconnectVersion = null);
        ...
        ErrorDocument GetError(ErrorCode errorCode, string cdata = null);
        ...
        /// <param name="cdata">The CDATA for Error contains a textual description of the error and any additional information an Agent is capable of providing regarding a specific error.</param>
        /// <returns>MTConnectError Response Document</returns>
        Task<ErrorDocument> GetErrorAsync(ErrorCode errorCode, string cdata = null);
        ...
        /// <returns>MTConnectError Response Document</returns>
        ErrorDocument GetError(IEnumerable<Error> errors);
        ...
        /// <param name="errors">A list of Errors to include in the response Document</param>
        /// <returns>MTConnectError Response Document</returns>
        Task<ErrorDocument> GetErrorAsync(IEnumerable<Error> errors);
        ...
        /// </summary>
        bool AddObservation(string deviceName, string dataItemId, object value);

        /// <summary>
        /// Add a new Observation for a DataItem of category EVENT or SAMPLE to the Agent
        /// </summary>
        Task<bool> AddObservationAsync(string deviceName, string dataItemId, object value);

        /// <summary>
        /// Add a new Observation for a DataItem of category EVENT or SAMPLE to the Agent
        /// </summary>
        bool AddObservation(string deviceName, string dataItemId, string valueType, object value);

        /// <summary>
        /// Add a new Observation for a DataItem of category EVENT or SAMPLE to the Agent
        /// </summary>
        Task<bool> AddObservationAsync(string deviceName, string dataItemId, string valueType, object value);
        ...
        /// </summary>
        bool AddAsset(string deviceName, IAsset asset);

        /// <summary>
        /// Add a new Asset to the Agent
        /// </summary>
        Task<bool> AddAssetAsync(string deviceName, IAsset asset);

        /// <summary>
        /// Add new Assets to the Agent
        /// </summary>
        bool AddAssets(string deviceName, IEnumerable<IAsset> assets);

        /// <summary>
        /// Add new Assets to the Agent
        /// </summary>
        Task<bool> AddAssetsAsync(string deviceName, IEnumerable<IAsset> assets);
