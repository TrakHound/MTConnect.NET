...
namespace MTConnect.Buffers
{
    ...
    {       
        ...
        private readonly ConcurrentDictionary<string, Assets.IAsset> _storedAssets = new ConcurrentDictionary<string, Assets.IAsset>();
        ...
        /// </summary>
        public IEnumerable<Assets.IAsset> GetAssets(string type = null, bool removed = false, int count = 100)
        {
        ...
        /// Get a list of all Assets from the Buffer
        /// </summary>
        public async Task<IEnumerable<Assets.IAsset>> GetAssetsAsync(string type = null, bool removed = false, int count = 100)
        {
            var assets = _storedAssets.Values.ToList();
        ...
        public Assets.IAsset GetAsset(string assetId)
        {
            if (_storedAssets.TryGetValue(assetId, out Assets.IAsset asset))
            {
                return asset;
            }
        ...
        /// </summary>
        /// <param name="assetId">The ID of the Asset to return</param>
        public async Task<Assets.IAsset> GetAssetAsync(string assetId)
        {
            if (_storedAssets.TryGetValue(assetId, out Assets.IAsset asset))
            {
                return asset;
        ...
        public bool AddAsset(Assets.IAsset asset)
        {
            if (asset != null)
            {
        ...
        /// </summary>
        /// <param name="asset">The Asset to add to the Buffer</param>
        public async Task<bool> AddAssetAsync(Assets.IAsset asset)
        {
