    ...
    public static class MTConnectHttpRequests
    {
            ...
            )
        {
            ...
            if (document != null)
            {
                ...
                return new MTConnectHttpResponse(document, documentFormat, stpw.ElapsedMilliseconds, indent);
            }
            else
            {
                ...
                return new MTConnectHttpResponse(error404Document, 404, documentFormat, stpw.ElapsedMilliseconds, indent);
            }
        }
            ...
            )
        {
            ...
            return new MTConnectHttpResponse(errorDocument, 400, documentFormat, stpw.ElapsedMilliseconds, indent);
        }
        ...
        )
        {
            ...
            if (at > 0 && at < mtconnectAgent.FirstSequence)
            {
                ...
                return new MTConnectHttpResponse(errorDocument, 404, documentFormat, stpw.ElapsedMilliseconds, indent);
            }
            ...
            var document = await mtconnectAgent.GetDeviceStreamsAsync(at);
            if (document != null)
            {
        ...
        )
        {
            ...
            {
                // Get MTConnectStreams document from the MTConnectAgent
                var document = await mtconnectAgent.GetDeviceStreamAsync(deviceName);
                if (document != null)
                {
                    // Return MTConnectStreams Response Document
                    return new MTConnectHttpResponse(document, documentFormat, stpw.ElapsedMilliseconds, indent);
        ...
        )
        {
            ...
            // Get MTConnectStreams document from the MTConnectAgent
            var document = await mtconnectAgent.GetDeviceStreamsAsync(from, to, count);
            if (document != null)
            {
                // Return MTConnectStreams Response Document
                return new MTConnectHttpResponse(document, documentFormat, stpw.ElapsedMilliseconds, indent);
        ...
        )
        {
            ...
            {
                // Get MTConnectStreams document from the MTConnectAgent
                var document = await mtconnectAgent.GetDeviceStreamAsync(deviceName, from, to, count);
                if (document != null)
                {
                    // Return MTConnectStreams Response Document
                    return new MTConnectHttpResponse(document, documentFormat, stpw.ElapsedMilliseconds, indent);
