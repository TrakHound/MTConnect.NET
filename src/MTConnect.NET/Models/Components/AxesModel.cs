...
namespace MTConnect.Models.Components
{
    ...
    public class AxesModel : ComponentModel, IAxesModel
    {
        ...
        public ILinearAxisModel GetXAxis(string suffix = null) => GetComponentModel<LinearAxisModel>(typeof(LinearComponent), CreateAxisName("X", suffix));
        ...
        public ILinearAxisModel GetYAxis(string suffix = null) => GetComponentModel<LinearAxisModel>(typeof(LinearComponent), CreateAxisName("Y", suffix));
        ...
        public ILinearAxisModel GetZAxis(string suffix = null) => GetComponentModel<LinearAxisModel>(typeof(LinearComponent), CreateAxisName("Z", suffix));
        ...
        public IRotaryAxisModel GetAAxis(string suffix = null) => GetComponentModel<RotaryAxisModel>(typeof(RotaryComponent), CreateAxisName("A", suffix));
        ...
        public IRotaryAxisModel GetBAxis(string suffix = null) => GetComponentModel<RotaryAxisModel>(typeof(RotaryComponent), CreateAxisName("B", suffix));
        ...
        public IRotaryAxisModel GetCAxis(string suffix = null) => GetComponentModel<RotaryAxisModel>(typeof(RotaryComponent), CreateAxisName("C", suffix));
    }
}
