...
namespace MTConnect.Models.Components
{
    ...
    public class SystemsModel : ComponentModel, ISystemsModel
    {
        ...
        /// </summary>
        public IHydraulicModel Hydraulic => GetComponentModel<HydraulicModel>(typeof(HydraulicComponent));

        /// <summary>
        /// Hydraulic is a System that represents the information for a system comprised of all the parts involved in moving and distributing pressurized liquid throughout the piece of equipment.
        /// </summary>
        public IPneumaticModel Pneumatic => GetComponentModel<PneumaticModel>(typeof(PneumaticComponent));
        ...
        /// </summary>
        public ICoolantModel Coolant => GetComponentModel<CoolantModel>(typeof(CoolantComponent));
        ...
        /// </summary>
        public ILubricationModel Lubrication => GetComponentModel<LubricationModel>(typeof(LubricationComponent));
        ...
        /// </summary>
        public IElectricModel Electric => GetComponentModel<ElectricModel>(typeof(ElectricComponent));
        ...
        /// </summary>
        public IProtectiveModel Protective => GetComponentModel<ProtectiveModel>(typeof(ProtectiveComponent));
        ...
        /// </summary>
        public IProcessPowerModel ProcessPower => GetComponentModel<ProcessPowerModel>(typeof(ProcessPowerComponent));
        ...
        /// </summary>
        public IFeederModel Feeder => GetComponentModel<FeederModel>(typeof(FeederComponent));
        ...
        /// </summary>
        public IDielectricModel Dielectric => GetComponentModel<DielectricModel>(typeof(DielectricComponent));
        ...
        /// </summary>
        public IEndEffectorModel EndEffector => GetComponentModel<EndEffectorModel>(typeof(EndEffectorComponent));
        ...
        /// </summary>
        public IWorkEnvelopeModel WorkEnvelope => GetComponentModel<WorkEnvelopeModel>(typeof(WorkEnvelopeComponent));
        ...
        /// </summary>
        public IHeatingModel Heating => GetComponentModel<HeatingModel>(typeof(HeatingComponent));
        ...
        /// </summary>
        public ICoolingModel Cooling => GetComponentModel<CoolingModel>(typeof(CoolingComponent));
        ...
        /// </summary>
        public IPressureModel Pressure => GetComponentModel<PressureModel>(typeof(PressureComponent));
        ...
        /// </summary>
        public IVacuumModel Vacuum => GetComponentModel<VacuumModel>(typeof(VacuumComponent));
