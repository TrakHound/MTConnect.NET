...
namespace MTConnect.Models.Components
{
    ...
    public class ToolingDeliveryModel : AuxiliaryModel, IToolingDeliveryModel
    {
        ...
        /// </summary>
        public IAutomaticToolChangerModel AutomaticToolChanger => GetComponentModel<AutomaticToolChangerModel>(typeof(AutomaticToolChangerComponent));
        ...
        /// </summary>
        public IToolMagazineModel ToolMagazine => GetComponentModel<ToolMagazineModel>(typeof(ToolMagazineComponent));
        ...
        /// </summary>
        public ITurretModel Turret => GetComponentModel<TurretModel>(typeof(TurretComponent));
