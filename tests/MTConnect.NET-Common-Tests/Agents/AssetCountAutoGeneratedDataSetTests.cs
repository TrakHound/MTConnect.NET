...
namespace MTConnect.Tests.Common.Agents
{
    ...
    {
        /// <summary>Pins the behaviour expressed by the test name: auto injected asset count has data set representation.</summary>
        [Test]
        ...
        /// <summary>Pins the behaviour expressed by the test name: user declared asset count representation is preserved.</summary>
        [Test]
