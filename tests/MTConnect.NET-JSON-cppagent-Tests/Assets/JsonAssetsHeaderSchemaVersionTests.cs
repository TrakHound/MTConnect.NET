...
namespace MTConnect.Tests.JsonCppagent.Assets
{
    ...
    public class JsonAssetsHeaderSchemaVersionTests
    {
        ...
        /// <summary>Pins the behaviour expressed by the test name: serialized assets header emits schema version property.</summary>
        /// <param name="schemaVersion">The schema version.</param>
        [TestCaseSource(typeof(JsonHeaderWireShapeMatrix), nameof(JsonHeaderWireShapeMatrix.SchemaVersionCases))]
        ...
        /// <summary>Pins the behaviour expressed by the test name: serialized assets header emits test indicator property.</summary>
        [Test]
